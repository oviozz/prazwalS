...
export const ProjectCard = ({data}) => {
    ...
    return (
        ...
        <Link
            ...
            className="group disableCopying project-card to-slate-950 relative max-w-sm h-[18.5rem] overflow-hidden rounded-xl border-2 border-solid border-gray-700  bg-[rgb(35, 34, 32)] w-full opacity-100 rounded-8 pt-7 pr-7 pl-7 shadow-2xl flex flex-col justify-between"
        >
            <div
            ...
            <div className={'lg:pr-2 lg:pl-2 hover-move-up'}>
                <img
                    className={"rounded-b-none rounded-lg h-full"}
                    src={imageUrl}
                />
